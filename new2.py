...
nuevos_datos = pd.DataFrame({
    ...
    'Bmi': [bmi]  # Asegurarse de incluir el BMI
})
...
if nuevos_datos_transformados.shape[1] != modelo_cargado.n_features_in_:
    st.error(f"El modelo espera {modelo_cargado.n_features_in_} características, pero los datos tienen {nuevos_datos_transformados.shape[1]}. Verifique los datos ingresados.")
    st.stop()
